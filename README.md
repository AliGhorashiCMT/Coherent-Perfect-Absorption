...
- Extensions to radially anisotropic systems as well as more refined surface scattering calculations: https://hackmd.io/@aligho/ByD_VEsdMg
    - In relation to radially anisotropic systems, we derive the key results of the following paper: [Influence of spherically anisotropic core on the optical properties of gold nanoshell](https://link.springer.com/article/10.1007/s00339-008-4951-y) by **Wu** and **Liu**
